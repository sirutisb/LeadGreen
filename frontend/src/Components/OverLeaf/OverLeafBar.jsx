        ...
        >
          ...
          >
            {inventory.map((item) => (
              ...
              >
                <motion.div className="tooltip" initial={{ opacity: 0, y: 10, scale: 0.8 }} 
                  animate={{ 
                    opacity: hoveredItem === item.id ? 1 : 0, 
                    y: hoveredItem === item.id ? -5 : 10,
                ...
                >
                  <motion.div
                    className="relative"
                    animate={{
                      scale: selectedIcon === item.id ? 1.15 : hoveredItem === item.id ? 1.05 : 1,
                    }}
                  ...
                  >
                    ...
                    {selectedIcon === item.id && (
                      <motion.div
                        ...
                        style={{ 
                          background: "radial-gradient(circle, rgba(0, 231, 66, 0.12) 0%, rgba(0, 255, 72, 0) 70%)",
                        }}
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                  ...
                  <motion.div
                    ...
                    animate={{
                      scale: hoveredItem === item.id || selectedIcon === item.id ? 1.1 : 1,
                    }}
                  >
                    {item.amount}
                  </motion.div>
                  ...
                  <motion.div 
                    ...
                    animate={{
                      scale: selectedIcon === item.id ? 1.05 : 1,
                      fontWeight: selectedIcon === item.id ? "700" : "600"
                    }}
                  >
                    {item.label}
                  </motion.div>
